...
import { Owl, PokeBallPark } from "../_components/design";

const Contact = () => {
  return (
    <section id="contact" className="pt-32 pb-32 relative overflow-hidden">
      <div className="global-container ">
        <div className="w-full relative z-10">
          ...
          <p className="max-w-2xl mx-auto text-center font-red-hat text-base max-md:text-sm leading-8 font-light text-tertiary mt-8">
